    ...
    >
      ...
      <div className="battle-arena-stage">
        ...
        <div className={`stage-fighter-card player-side ${!isEnemyTurn ? 'pulse' : ''}`}>
          ...
          {/* Static Gear Locked Indicator */}
          <div style={{ fontSize: '0.64rem', color: '#9ca3af', fontWeight: 800, marginTop: '0.35rem', display: 'inline-flex', alignItems: 'center', gap: '0.25rem', background: 'rgba(0,0,0,0.4)', padding: '0.15rem 0.45rem', borderRadius: '6px', border: '1px solid rgba(255,255,255,0.1)' }}>
            <Lock size={10} color="#9ca3af" />
            <span>GEAR LOCKED</span>
          </div>
        </div>
